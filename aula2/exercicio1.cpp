...
int main()
{
    ...
    do
    {
        ...
        cout << "3 - Exibir media dos elementos do vetor\n";
        cout << "4 - Sair\n";
        cout << "Opcao: ";
        cin >> opcao;
        ...
        case 3:
            cout << "Exibir media dos elementos do vetor\n";
            if (qtd_elementos > 0)
            {
                float media = 0;
                int soma = 0;
                ...
                media = soma / static_cast<float>(TAMANHO);
                cout << "A media dos elementos do vetor e: " << ::fixed << setprecision(2) << media << endl;
            }
            else
            {
                cout << "Vetor vazio\n";
